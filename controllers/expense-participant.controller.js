...
exports.addParticipantToExpense = async (req, res) => {
    try {
      const addedParticipant = await expenseParticipantServices.addParticipantToExpense({
        body: req.body,
        params: req.params,
  ...
  exports.removeParticipantFromExpense = async (req, res) => {
    try {
      const removedParticipant = await expenseParticipantServices.removeParticipantFromExpense({
        params: req.params,
        currentUser: req.user,
      });
  ...
  exports.updateSetelmentStatus = async (req, res) => {
    try {
      const updatedSetelment = await expenseParticipantServices.updateSetelmentStatus({
        params: req.params,
      });
